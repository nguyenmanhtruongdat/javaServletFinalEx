								...
								<div class="container">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label for="masv">Mã
													sinh viên <span><span>*</span></span>
												</label> <input type="text" name="masv" class="form-control"
													id="masv" required />
											</div>
										</div>
										<div class="col-md-12">
											<div class="form-group">
												<label for="hoten">Họ
													tên <span><span>*</span></span>
												</label> <input type="text" id="hoten" class="form-control"
													name="hoten" required />
											</div>
										</div>
									</div>
										...
										<div class="col-md-12">
											<div class="form-group">
												<label for="ngaysinh">Ngày sinh <span>*</span></label> <input
													type="date" name="dob" value="" min="1997-01-01"
													max="2030-12-31" value="${std.ngaysinh}"
													required="required" class="form-control" id="ngaysinh">
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label for="sdt">Số
													điện thoại cá nhân <span>*</span>
												</label> <input type="text" name="sdtSV" class="form-control"
										...
										<div class="col-md-6">
											<div class="form-group">
												<label for="sdt">Số
													điện thoại gia đình <span>*</span>
												</label> <input type="text" name="sdtPH" class="form-control"
													id="sdt" required="required" />
											</div>
										</div>
									</div>
