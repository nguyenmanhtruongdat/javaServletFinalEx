								...
								<div class="container">
									<div class="controls">
										...
										<div class="row">
											...
											<div class="col-md-10">
												<div class="form-group">
													<input type="date" name="dob" min="1997-01-01"
											...
											<div class="col-md-10">
												<div class="form-group" style="display: flex;">
													<label for="nam">Nam </label> <input type="radio" id="nam"
														name="gioitinh" value="1" required="required"
														class="form-control" id="gioitinh"> <label
														for="nu">Nữ </label> <input type="radio" id="nu"
														name="gioitinh" value="0" required="required"
														class="form-control" id="gioitinh">
												</div>
											</div>
										</div>
