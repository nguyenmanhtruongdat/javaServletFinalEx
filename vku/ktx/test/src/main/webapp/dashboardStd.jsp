...
<body>
	...
	<main style="margin-top: 58px">
		...
		<table class="table table-striped">
			<thead>
				<tr>
					...
					<th scope="col">Số điện thoại sinh viên</th>
					...
					<tr>
						...
						<td>
							<button class="btn btn-success"
								onclick="javascript:showUpdate('${x.masv}')">Sửa</button>
							<button type="button" class="btn btn-danger"
								onclick="showMess('${x.masv}')">Xóa</button>
						</td>
					</tr>
		...
		<!--	<button type="button" class="btn btn-danger" onclick="loadMore()">Xóa</button> -->
