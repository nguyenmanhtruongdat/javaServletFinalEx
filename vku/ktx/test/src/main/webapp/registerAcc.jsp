...
<body>
					...
					<div class="form-group">
						<div class="input-group">
							...
							<input type="password" class="form-control"
								placeholder="Mật khẩu dài 8 kí tự bao gồm chữ hoa, thường, số" id="password" name="password" required />
	...
	const cfpassword = document.getElementById("cfpassword");
		...
		cfpassword.addEventListener('input', () => {
				if (password.value.match(passwordPatterm) && cfpassword.value==password.value) {
