												...
												<div class="col-md-12">
													<div class="form-group">
														<label for="ngaysinh">Ngày sinh <span>*</span></label> <input
															type="date" name="dob" min="1997-01-01" max="2030-12-31"
															value="${std.ngaysinh}" required="required"
												...
												<div class="col-md-12">
													<div class="form-group">
														...
														Nam <input type="radio" name="gioitinh" value="1"
															${std.gioitinh == 1 ? "checked":""}> &nbsp &nbsp
														&nbsp &nbsp Nữ <input type="radio" name="gioitinh"
															value="0" ${std.gioitinh == 0 ? "checked":""}>
													</div>
												</div>
