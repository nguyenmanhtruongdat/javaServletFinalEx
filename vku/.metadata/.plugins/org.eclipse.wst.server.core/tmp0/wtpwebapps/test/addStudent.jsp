      ...
      <div class="collapse navbar-collapse" id="navbarColor03">
        <ul class="navbar-nav mr-auto">
          ...
          <c:if test="${sessionScope.acc.isAdmin==1}">
            <li class="nav-item dropdown">
              ...
              >
              <div class="dropdown-menu">
                <a class="dropdown-item" href="quanlySV">Quản lý sinh viên</a>
                <a class="dropdown-item" href="quanlyPhong">Quản lý phòng</a>
                <a class="dropdown-item" href="quanlyAcc">Quản lý tài khoản</a>
              </div>
            </li>
          </c:if>
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item" href="editLiver.jsp"
                  >Cập nhật thông tin ở nội trú</a
                >
                <a class="dropdown-item" href="editInfor.jsp"
                  >Cập nhật thông tin các nhân</a
                >
              </div>
            </li>
          </c:if>
          ...
          <c:if test="${sessionScope.acc.isAdmin==1}">
            <li class="nav-item dropdown">
              ...
              >
              <div class="dropdown-menu">
                <a class="dropdown-item" href="">Duyệt đăng ký phòng</a>
                <a class="dropdown-item" href=""
                  >Liên lạc sinh viên, phụ huynh</a
                >
                <a class="dropdown-item" href="">Thông báo nộp tiền</a>
                <a class="dropdown-item" href="">Thông báo hết hạn</a>
              </div>
            </li>
          </c:if>
          ...
          <c:if test="${sessionScope.acc.isAdmin==1}">
            <li class="nav-item">
              <a class="nav-link" href="dashboard.jsp">Đến trang quản lý</a>
            </li>
          </c:if>
        ...
        <c:if test="${sessionScope.acc!=null}">
          <ul class="nav navbar-nav navbar-right">
            <li>
              <a href="logout"
                ><i class="fa-solid fa-right-to-bracket"></i>Đăng xuất</a
              >
            </li>
          </ul>
        </c:if>
                  ...
                  <div class="container">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label for="masv"
                            >Mã sinh viên <span><span>*</span></span></label
                          >
                          <input
                            type="text"
                            name="masv"
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          <label for="hoten"
                            >Họ tên <span><span>*</span></span></label
                          >
                          <input
                            type="text"
                            id="hoten"
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label for="sdt"
                            >Số điện thoại cá nhân <span>*</span></label
                          >
                          <input
                            type="text"
                            name="sdtSV"
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label for="sdt"
                            >Số điện thoại gia đình <span>*</span></label
                          >
                          <input
                            type="text"
                            name="sdtPH"
